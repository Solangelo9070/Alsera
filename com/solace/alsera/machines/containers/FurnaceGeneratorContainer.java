...
public class FurnaceGeneratorContainer extends AbstractContainerMenu {
    ...
    public FurnaceGeneratorContainer(int windowId, BlockPos pos, Inventory playerInventory, Player player) {
        super(ModContainers.FURNACE_GENERATOR.get(), windowId);
    ...
    public boolean stillValid(Player playerIn) {
        return stillValid(ContainerLevelAccess.create(blockEntity.getLevel(), blockEntity.getBlockPos()), playerEntity, ModBlocks.FURNACE_GENERATOR.get());
    }
