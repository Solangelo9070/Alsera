...
public class FurnaceGeneratorL2Screen extends AbstractContainerScreen<FurnaceGeneratorL2Container> {

    private final ResourceLocation GUI = new ResourceLocation(Alsera.MOD_ID, "textures/gui/furnace_generator_gui.png");

    public FurnaceGeneratorL2Screen(FurnaceGeneratorL2Container container, Inventory inv, Component name) {
