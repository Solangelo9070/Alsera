...
public class BeginningBiomeProvider extends BiomeSource {

    public static final Codec<BeginningBiomeProvider> CODEC = RegistryOps.retrieveRegistry(Registry.BIOME_REGISTRY)
            .xmap(BeginningBiomeProvider::new, BeginningBiomeProvider::getBiomeRegistry).codec();

    private final Holder<Biome> biome;
    private final Registry<Biome> biomeRegistry;
    private static final List<ResourceKey<Biome>> SPAWN = Collections.singletonList(Biomes.PLAINS);

    public BeginningBiomeProvider(Registry<Biome> biomeRegistry) {
